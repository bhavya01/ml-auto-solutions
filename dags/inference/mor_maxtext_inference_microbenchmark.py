...
from dags.inference.configs import mor_maxtext_inference_microbenchmark_gce_config
...
BASE_OUTPUT_DIRECTORY = "gs://inference-benchmarks/logs/mor-maxtext-inference-microbenchmark"
...
def generate_model_configs(
  ...
  mor_maxtext_kv_cache_layout_optimization = mor_maxtext_inference_microbenchmark_gce_config.config(
  ...
  return mor_maxtext_kv_cache_layout_optimization
        ...
        for ici_parallelism in sweep_model_configs["ici_parallelisms"]:
          for per_device_batch_size in sweep_model_configs["per_device_batch_sizes"]:
            for vm_number in range(sweep_vm_count):
              mor_maxtext_kv_cache_layout_optimization = generate_model_configs(
